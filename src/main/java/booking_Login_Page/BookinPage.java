...
public class BookinPage extends Base{
	static WebDriver driver;
	
	
	
	public static void selectbestflight() {
		...
		List<WebElement> arrow=driver.findElements(By.xpath("//span[contains(@class,'fli-arrow arrow-down-icon')]"));
		if(s>1 && similar_duration>=1) {
